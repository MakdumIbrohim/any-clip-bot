...
assert.equal(detectPlatform("https://www.youtube.com/shorts/abc123"), "youtube");
...
assert.equal(detectPlatform("https://www.instagram.com/reel/Cabc/"), "instagram");
...
assert.equal(detectPlatform("https://www.threads.net/@user/post/Cabc"), "threads");
assert.equal(detectPlatform("https://gmail.com/inbox"), null);
assert.equal(detectPlatform("not a url"), null);
assert.equal(extractUrl("coba ini https://youtu.be/abc ya bro"), "https://youtu.be/abc");
assert.equal(extractUrl("link (https://x.com/a/status/1)."), "https://x.com/a/status/1");
